...
async def edit_anime_menu():
    markup = ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="📝 Nomi (name)ni tahrirlash"), KeyboardButton(text="🎭 Janrini (genre) tahrirlash")],
            [KeyboardButton(text="🎞 Qismlar sonini (count_episode) tahrirlash"), KeyboardButton(text="🖼 Rasm (image) havolasini tahrirlash")],
